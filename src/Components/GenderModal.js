...
const GenderModal = ({modalVisible, setModalVisible, setValue}) => {
        ...
        <View style={styles.wrapperContainer}>
          <View style={styles.solidPart}>
            <View style={styles.topContainer}>
              ...
              <Text style={styles.titleTxt}>الجنس</Text>
            </View>

            <Divider style={styles.divider} />

            <View style={styles.contentContainer}>
              <ImageAndTitle title="ذكر" image={Images.maleSign} />

              <ImageAndTitle title="أنثى" image={Images.femaleSign} />

              {/* <ImageAndTitle title="آخر" image={Images.other} /> */}
            </View>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  dismissPart: {flex: 1.9, backgroundColor: 'rgba(0, 0, 0, 0.5)'},
  wrapperContainer: {
